...
IKEv1とIKEv2は名前こそ似ていますが、メッセージ交換の設計自体が刷新された別バージョンです。両者の違い（EAP認証・Configuration Payload・MOBIKEなど）は比較表つきで[L2TP/IPsecと現代的なVPNプロトコルを『上位1%』の視点で比較する](/articles/vpn-protocols-comparison-guide)の「IKEv2/IPsec:L2TPを介さない『進化系』」で詳しく扱っています。実際に稼働中のIKEv1構成をIKEv2へバージョンアップする案件で気をつけるべき点（多くは拠点間VPNの文脈で発生します）は、[拠点間VPN(Site-to-Site VPN)を『上位1%』の視点で理解する](/articles/site-to-site-vpn-guide)で扱っています。
