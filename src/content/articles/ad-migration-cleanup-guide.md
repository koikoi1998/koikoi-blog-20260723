...
- **MMC(Microsoft Management Console)スナップイン**: `dsa.msc`や`dssite.msc`のような管理コンソールは、いずれもMMCという共通の枠組みの上に構築された「スナップイン」です。それぞれが、AD DSという1つのデータベースの中の異なる部分を、異なる見た目・操作性で見せている、という関係を理解しておくと、以降の整理がしやすくなります。
