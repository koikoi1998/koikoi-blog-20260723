...
- **セキュアチャネル**: コンピューターがこのパスワードを使ってDCに対して自分自身を認証し、確立するNetlogon経由の暗号化された通信路です。「コンピューター自身がAD DSに登録された自分のパスワードを正しく提示できる状態」がセキュアチャネルが健全であることの実体であり、AD DS側の記録(パスワード)とコンピューター自身がローカルに保持する記録が食い違うと、セキュアチャネルは切れます。このセキュアチャネルおよびNetlogonサービスの詳しい仕組みは、別記事で深掘りします。
