---
title: "インストーラのx64とx86の違いを『上位1%』の視点で理解する——なぜ統一されないのか"
description: "インストーラにx64版とx86版が別々に用意されているのはなぜか。間違ったアーキテクチャをインストールすると何が起きるのか。そしてなぜ今も統一されないのかを体系的に理解する。"
...
- **この記事で得られること**: ソフトウェアのダウンロードページでよく見かける**x64版・x86版という選択肢**が、そもそも何を表しているのか、**なぜ間違ったものをインストールすると問題が起きるのか、そしてなぜ今も統一されずに別々に配布され続けているのか**を体系的に理解します。
...
DELL Server Update Utilityのようなツールでダウンロードされる**ISOファイルを右クリックして「マウント」する**という操作が具体的に何を行っているのかは、テーマが異なるため[ISOファイルの「マウント」とは何か](/articles/iso-mount-guide)で別記事として深掘りしています。
...
2. ドライバ・ファームウェアの更新パッケージを取得する前に、対象サーバー・PCのCPU・OSのビット幅を必ず確認する習慣をつけましょう。
