...
過去記事で扱った内容は「読んだ前提」で話を進める記事もあります。前提知識が必要な箇所には、該当する過去記事へのリンクを埋め込んでいるので、そこから遡って読んでください。
...
- [サーバー電源の仕組みを『上位1%』の視点で理解する](/articles/idrac-power-guide) — iDRACの前提となる、AC/DC変換・PSU冗長化（A/Bグリッド・ホットスペア）の深掘り。
