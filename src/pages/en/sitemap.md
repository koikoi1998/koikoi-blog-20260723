...
graph TB
    ...
    Dns["④ dns-guide<br/>(How DNS Works)"]
    ...
    Daemon["⑤ linux-daemon-guide<br/>(What Is a Daemon)"]
    Library["⑤ software-library-guide<br/>(What Is a Library)"]
    UserKernel["⑤ linux-user-kernel-space-guide<br/>(User/Kernel Space and TUN/TAP)"]
...
A series that takes execution-environment-level terms that keep showing up in the VPN protocol articles and gives each one a standalone deep dive.
