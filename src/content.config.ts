...
const articleSchema = z.object({
  ...
  series: z.enum(["idrac", "network", "vpn", "modern-vpn", "site-to-site-vpn", "linux", "telephony", "api", "security", "handson-prep", "virtualization", "active-directory", "windows-client", "windows-server", "storage"]),
  order: z.number(),
